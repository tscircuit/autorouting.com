  ...
  return (
    <main className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="container mx-auto max-w-2xl px-4 py-8 bg-white shadow-lg rounded-lg">
        ...
        <p className="text-lg mb-4 text-gray-700">
          We're releasing <a href="https://github.com/tscircuit/autorouting-datasets" className="text-blue-600 hover:underline">open datasets and benchmarks</a> for autorouting. You should <a href="https://blog.autorouting.com" className="text-blue-600 hover:underline">subscribe on Substack</a> to hear about big releases (expect something ~once a month)
        </p>
      </div>
    </main>
  );
